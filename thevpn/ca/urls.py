...
from .views import ca_crl, create_certificate, show_certificate, list_certificates, revoke_certificate, show_certificate_authority
...
try:
    urlpatterns = [
        ...
        url(r'^certificate/list/(?P<type>(all|active|valid|revoked|duplicate)?)',
            list_certificates,
    ...
    print("Received a database error, did you execute `manage.py migrate` already?")
    urlpatterns = []
